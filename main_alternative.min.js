...
$.extend($.easing, {
    ...
    (Riode.defaults = {
        animation: { name: "fadeIn", duration: "0.5s", delay: ".2s" },
    ...
    (Riode.priceSlider = function (e, t) {
        "object" == typeof noUiSlider &&
            Riode.$(e).each(function () {
                var e = this;
                noUiSlider.create(e, $.extend(!0, { start: [min_price_slide, max_price_slide], connect: !0, step: 1, range: { min: min_price_slide, max: max_price_slide } }, t)),
                    e.noUiSlider.on("update", function (t, i) {
                        ...
                        price_min = parseInt(t[0].slice(1,t[0].length))
                        price_max = parseInt(t[1].slice(1,t[0].length))
        ...
        var t = Riode.$(e);
            ...
            Riode.$body.on("click", ".sticky-footer .search-toggle", function (e) {
                ...
                $(this).parent().toggleClass("show"),
                 $(".search_mobile_container").toggleClass("show"),$("body").toggleClass("hidden_body"), e.preventDefault();
                
                if (!$(".search_mobile_container.show")[0]){

                     $(this).parent().find(".sticky-link").html(`
    ...
    (Riode.stickyHeader = function (e) {
        ...
        if (0 != t.length) {
            ...
            window.addEventListener("scroll", s, { passive: !0 }), Riode.$window.on("resize", a), Riode.$window.on("resize", s), Riode.call(a, 250), Riode.call(s, 250);
        }
    }),
        ...
        Riode.$body
            .on("click", ".tab .nav-link", function (e) {
                ...
                if ((e.preventDefault(), !t.hasClass("active"))) {
                    var i = $(t.attr("href"));
                    i.siblings().removeClass("in active"), i.addClass("active in"), t.parent().parent().find(".active").removeClass("active"), t.addClass("active");
                }
            })
            ...
            (e.prototype.toggle = function () {
                ...
                if (window.innerWidth >= Riode.minDesktopWidth && e.$sidebar.hasClass("sidebar-fixed")) {
                    ...
                    e.$sidebar.find(".sidebar-overlay .sidebar-close").css("margin-left", -(window.innerWidth - document.body.clientWidth)),
                        ...
                        window.innerWidth >= 1200 && Riode.$body.hasClass("with-flex-container")
            }),
            function (t) {
                return new e(t);
            }
    ...
    (Riode.initProductSingle = (function () {
        ...
        return (
            ...
            (e.prototype.variationMatch = function () {
                this.$priceWrap.find("span").text($(".l_price_pr").text()), this.$priceWrap.slideDown(), this.$clean.slideDown(), this.$btnCart.removeAttr("disabled");
            }),
    ...
    (Riode.initProductSinglePage = (function () {
        ...
        function i(e) {
            ...
            t.hasClass("added") ||
                ...
                alert("Կայքը գտնվում է թեստային վիջակում")
                /*setTimeout(function () {
                    t.removeClass("load-more-overlay loading").html('<i class="d-icon-heart-full"></i> Browse wishlist').addClass("added").attr("title", "Browse wishlist").attr("href", "#");
                }, 500)*/
                );
        }
        return function () {
...
/*
    (Riode.quantityInput = (function () {
        ...
        return (
            ...
            (e.prototype.init = function (t) {
                ...
                (i.$minus = !1),
                    ...
                    (val_ue = e.value),
                    (i.value_one = t.val((i.value = e.value))+1),
                    (i.$minus = t
                        .prev()
        ...
        var total_price = $(".totla_price_cart").text()
        console.log(i.value)
        if (parseInt(i.value)!=1){
            $(".totla_price_cart").html((parseFloat(total_price)-parseFloat(price)))
             all_price-=parseFloat(price)
             val_ue--;
             count_click++;
             count_product--;
             console.log("a1", count_product)
            ...
            //$(".totla_price_cart").html($(".totla_price_cart").attr("total"))
                //$(".totla_price_cart1").html($(".totla_price_cart1").attr("total"))
         ...
         ; e.cancelable && e.preventDefault(), i.startDecrease();
                    ...
                    (i.$plus = t
                        ...
                        .on("mousedown", function (e) {
                            ...
                            e.cancelable && e.preventDefault(), i.startIncrease();var price = $(this).attr("price")
        var total_price = $(".totla_price_cart").text()
        var product_pk = $(this).attr("pk")
        val_ue++;
        count_product++;
        console.log("a3", count_product)
        
        if($("#p"+String(product_pk)+"p").attr("checkk")=="1"){
            $(".totla_price_cart").html((parseFloat(total_price)+parseFloat(price)))
        all_price+=parseFloat(price)}
                        })
                        .on("touchstart", function (e) {
    ...
    */
    ...
    (Riode.Menu = {
        ...
        initMobileMenu: function () {
            ...
            $(".mobile-menu li, .toggle-menu li").each(function () {
                if (this.lastElementChild && ("UL" === this.lastElementChild.tagName || this.lastElementChild.classList.contains("megamenu"))) {
                    ...
                    (e.className = "toggle-btnn"), this.firstElementChild.appendChild(e);
                }
            }),
        ...
        initFilterMenu: function () {
            $(".search-ul li").each(function () {
                ...
                $(".with-ul > a i, .toggle-btnn").on("click", function (e) {
    ...
    (Riode.Shop = {
        ...
        initSelectMenu: function () {
            Riode.$body
                ...
                .on("click", ".filter-clean", function (e) {
                    $(".shop-sidebar .filter-items .active").removeClass("active"), e.preventDefault();console.log("aaaaaaaaa")
                    data_filter["price_min"]= min_price_slide
                    data_filter["price_max"]= max_price_slide
                    data_filter["sizes"]= []
                    data_filter["colors"]= []

                    change_filter(data_filter)
                })
                
                .on("click", ".filter-items a.sizes_open", function (e) {
                    var t = $(this).closest(".filter-items");
                    if ($(this).attr("status")!="unactive"){
                        $(this).attr("status", "unactive")
                        var index = data_filter["sizes"].indexOf($(this).attr("value"));
                        if (index > -1) {
                            data_filter["sizes"].splice(index, 1);
                        }

                    }else{
                        $(this).attr("status", "active")
                        data_filter["sizes"].push($(this).attr("value"))
                    ...
                    t.hasClass("search-ul") ||
                        ...
                        (t.hasClass("filter-price") ? ($(this).parent().siblings().removeClass("active"), $(this).parent().toggleClass("active"), console.log("aaa"),e.preventDefault() ): ($(this).parent().toggleClass("active"), e.preventDefault()));
                })
                 .on("click", ".filter-items a.colors_open", function (e) {
                    var t = $(this).closest(".filter-items");
                    if ($(this).attr("status")!="unactive"){
                        $(this).attr("status", "unactive")
                        var index = data_filter["colors"].indexOf($(this).attr("value"));
                        if (index > -1) {
                            data_filter["colors"].splice(index, 1);
                        }

                    }else{
                        $(this).attr("status", "active")
                        data_filter["colors"].push($(this).attr("value"))
        ...
        if (indicator!=undefined){
            name = $(this).attr("name_pr")
         pk = $(this).attr("product_pk")
        ...
        var comment_block = `<div class="product product-cart" id = "strjlfhf">
                                        <figure class="product-media">
                                            <a href="/shop/products/pk1">
                                                <img src="date_t" alt="product" width="80" height="88" data-stories_space_upload_el_handled="1">
                                            </a>
                                            <button class="btn btn-link btn-close btn_remove_product" product_pk = "pk2">
                                                <i class="fas fa-times"></i><span class="sr-only">Close</span>
                                            </button>
                                        </figure>
                                        <div class="product-detail">
                                            <a href="#" class="product-name">name_try</a>
                                            <div class="price-box">
                                                <span class="product-quantity">1</span>
                                                <span class="product-price">profile</span>
                                            </div>
                                        </div>
        ...
        `
            ...
            success: function(data){
                if (data.data!=0){
                    console.log(data.name, data.avatar_p, data.product_pay)
             var box = comment_block.replace("name_try", data.name)
             box = box.replace("date_t","/media/"+data.image)
             box = box.replace("profile", "$"+data.product_pay)
             box = box.replace("pk2", data.pk)
             box = box.replace("strjlfhf", "jj"+data.pk)
             box = box.replace("pk1", data.pk)
             
             $(".products_cart_po").append(box)
             
             $(".cart-count").text(data.count)
             $(".obj_price_total").html(parseInt($(".obj_price_total").text())+parseInt(data.product_pay))
              t.hasClass("product-single") ||
                        Riode.Minipopup.open({
                            ...
                            actionTemplate:
                                '<div class="action-group d-flex"><a href="/cart/" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="#" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                        });
    ...
    (Riode.init = function () {
        Riode.appearAnimate(".appear-animate"),
            ...
            //sRiode.slider(".owl-carousel"),
            Riode.headerToggleSearch(".search_mobile_container"),
