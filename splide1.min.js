    ...
    (t = function () {
        ...
        var _t = Object.freeze({
                ...
                Elements: function (n, t, i) {
                    ...
                    function l() {
                        ...
                        !(function () {
                            ...
                            var n = p("." + Hn),
                                t = p("." + Cn);
                            O(a, { root: f, slider: u, track: o, list: e, slides: s, arrows: t, autoplay: n, prev: q(t, "." + Nn), next: q(t, "." + Xn), bar: q(p("." + Bn), "." + Gn), play: q(n, "." + Yn), pause: q(n, "." + Un) });
                        })(),
                            (n =
                                f.id ||
                                (function (n) {
                ...
                Move: function (e, c, f) {
                    ...
                    function _(n, t) {
                        var i,
                            i = v(u(n - 1) - ((i = n), "center" === (n = f.focus) ? (o() - r(i, !0)) / 2 : +n * r(i) || 0));
                        return t
                            ? (function (n) {
                        ...
                        s || p("drag"),
                            (s = n).cancelable &&
                                ...
                                d
                                    ...
                                    : ((r = I((r = e.dragMinThreshold)) ? r : { mouse: 0, touch: +r || 10 }), (d = un(t) > (j(n) ? r.touch : r.mouse)), M() && U(n)));
                    }
                    function P(n) {
                        m(h, dt, z), m(h, vt, P);
                        var t,
